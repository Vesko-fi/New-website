...
import { securePaymentImg, optimizeLogisticImg, orderManagementImg } from '@constants/assets';
import { useTranslation } from 'react-i18next';

const Options: React.FC = () => {
  const {t} = useTranslation();
  return (
    <Section style={{ background: 'linear-gradient(180deg, #FFFFFF 0%, #F0F5FF 100%)' }} className='w-100%'>
      <Container className='flex flex-col md:flex-row items-center gap-8 lg:gap-16 px-2 md:px-8 lg:px-12'>
        <div>
