      ...
      <Section className="scroll-m-0 scroll-p-0">
        <Container className="flex flex-col items-center justify-between gap-8 lg:flex-row lg:gap-12 lg:py-24">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <img
              src={heroImgCheckout}
              alt="vesko's landing page image, screen showing checkout section with product details, price, order to home, reserve product, and buy and pick up at store options."
            ...
            <img
              src={heroImgProduct}
              alt="vesko's landing page image, Mobile screen displaying Vesko's product detail page with product image, thumbnails, name, brand, price, type, color, size, and other options."
